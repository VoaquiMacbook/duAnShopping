            ...
            screenOptions={({ route, navigation }) => ({
                headerLeft: () => (
                    <TouchableOpacity onPress={goToSetting} style={styles.btnSettingCon}>
                        <ImageBackground style={styles.backgroundColorSettingicon} source={require('../../../assets/image/Shop.png')}>
                            <Image style={styles.settingHome} source={require('../../../assets/image/Shop.png')} />
                ...
                headerRight: () => (
                    <TouchableOpacity onPress={goToPeronal}>
                        ...
                        <Image style={styles.avata} source={require('../../../assets/image/Shop.png')} />
                    </TouchableOpacity>
                ),
                ...
                tabBarIcon: ({ focused, color, size }) => {
                    ...
                    if (route.name === 'Home') {
                        if (focused) {
                            return <Image source={require('../../../assets/image/Shop.png')} />
                        }
                        return <Image source={require('../../../assets/image/Shop.png')} />
